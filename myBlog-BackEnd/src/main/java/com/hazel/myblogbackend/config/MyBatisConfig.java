package com.hazel.myblogbackend.config;
...
@MapperScan(basePackages = { "com.hazel.myblogbackend.*.model.mapper" })
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        session.setTypeAliasesPackage("com.hazel.myblogbackend.*.model");
